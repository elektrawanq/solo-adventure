...
public class Adventurer {
    ...
    public void receiveReward(Reward reward) {
        ...
        //ele subira
        while (experience >= (level/10 * 1000)){ //Faz com que a cada nivel seja preciso mais experiencia para subir de nivel
            experience -= level/10 * 1000;
            level += 1;
            verificador += 1;
        }
        ...
        addItem(reward.getItem());
    }

    public void addItem(Item item) {
        inventory.addItem(item);
        System.out.println("O item " + item.getName() + " foi adicionado ao invetario de " + name + " com sucesso!\n");
    }
}
